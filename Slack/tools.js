...
async function postMessage({ channel, text, blocks, thread_ts, unfurl_links, unfurl_media, token } = {}) {
...
async function postThreadReply({ channel, thread_ts, text, blocks, token } = {}) {
  if (!thread_ts) {
...
//#ReturnsType=string
//#ReturnsValue="ok"
async function postWebhook({ text, blocks, webhookUrl } = {}) {
